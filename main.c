...
#if 0
FILE *fp;
fp = fopen("D:\\etec\\mbedtls_test\\client.crt","rb");
...
ret = mbedtls_pk_parse_keyfile(&ec_prik_ctx, "D:\\etec\\mbedtls_test\\client.key", NULL, NULL, NULL);
...
int fd;
fd = open("D:\\etec\\mbedtls_test\\hash.bin",O_WRONLY);
if(fd < 0)
{
...
fd = open("D:\\etec\\mbedtls_test\\sig.bin",O_WRONLY);
if(fd < 0)
{
